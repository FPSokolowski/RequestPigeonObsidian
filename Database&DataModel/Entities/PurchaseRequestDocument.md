...
| RealPurchaseDate       | DateOnly                                      | date                       |    ✔     | Final date of a purchase event                                                                            | Allow assign after approval                                                                                                                        |
| RealCost               | decimal                                       | decimal(12,2)              |    ✔     | Final real cost                                                                                           | Allow assign after approval                                                                                                                        |
| AccountantsRecorded    | bool                                          | bit                        |    ❌     | Marked as closed by accountants. It blocks modify/add attachments.                                        | Default: FALSE. Change is possible after approval (and it starts to be visible for accountants). It can be changed only by accountants.            |
...
## Notes  
* Allow assign attachments after approval
